...
from ptgnn.neuralmodels.gnn.messagepassing.selfattmessagepassing import MultiHeadSelfAttentionMessagePassing
...
def create_sandwich_mlp_mp_layers(hidden_state_size, dropout_rate, num_edges: int):
    mlp_mp_constructor = lambda: MlpMessagePassingLayer(
        input_state_dimension=hidden_state_size,
        message_dimension=hidden_state_size,
        output_state_dimension=hidden_state_size,
    ...
    self_att_mp_constructor = lambda: MultiHeadSelfAttentionMessagePassing(
        input_state_dimension=hidden_state_size,
        key_query_dimension=hidden_state_size,
        value_dimension=hidden_state_size,
        intermediate_dimension=4 * hidden_state_size,
        output_dimension=hidden_state_size,
        num_heads=8,
        dropout_rate=dropout_rate,
    )
    mlp_mp_after_res_constructor = lambda: MlpMessagePassingLayer(
